...
obj <- contphasetype(initDist, Tmat)
...
initDist = c(1,0)
## and 
TmatMRCA = matrix(c(-3,3,0,-1), nrow = 2, byrow = TRUE)
TmatTotal = matrix(c(-2,2,0,-1), nrow = 2, byrow = TRUE)/2

## Defining two objects of class "contphasetype"
TMRCA <- contphasetype(initDist, TmatMRCA)
TTotal <- contphasetype(initDist, TmatTotal)
...
for (n in 4:20) {
  ...
  Tmat <- diag(choose(n:3,2))
  Tmat <- cbind(replicate(n-2,0),Tmat)
  Tmat <- rbind(Tmat, replicate(n-1,0))
