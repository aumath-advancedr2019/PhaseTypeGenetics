...
\end{pmatrix}.
\end{equation*}
Hence, the number of segregating sites plus one is also discrete phase-type distributed with initial distribution $\pi_i = (1,0,0,0)$ and subintensity rate matrix 
\begin{equation*}
