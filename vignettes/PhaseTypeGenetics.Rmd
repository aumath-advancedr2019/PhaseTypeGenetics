...
output: 
  rmarkdown::html_vignette:
    ...
    toc_depth: 4
vignette: >
  %\VignetteIndexEntry{PhaseTypeGenetics - An overview}
...
Now we consider continuous phase-type distributions. Hence, let $\tau \sim \text{PH}(\pi, T)$. Then the $n$'th order moment of $\tau$ is given as 
\begin{align*}
\mathbb{E}[\tau^n] =  n! \pi (-T)^{-n}e.
\end{align*}
